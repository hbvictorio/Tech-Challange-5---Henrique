...
**Subtitulo:** Transformando dados em oportunidades para criancas e jovens (2020-2024)
...
## Slide 9: Sistema de Alerta Precoce: Forecasting Verdadeiro (T -> T+1)
**Insight principal:** Desenvolvemos um modelo preditivo que usa os dados do Ano Atual (T) para prever o risco de defasagem no Proximo Ano (T+1). Isso elimina o "data leakage" e cria um alerta precoce real.
**Dados de suporte:** O modelo Random Forest treinado com dados de 2020-2023 e testado em 2023->2024 alcancou AUC-ROC de 63.5% e Recall de 58.3% em dados futuros nao vistos.
**Conclusao:** A ferramenta preditiva permite identificar mais da metade dos alunos em risco com um ano de antecedencia, possibilitando intervencao antes da queda efetiva no desempenho.
...
**Ponto 1:** Implementar o Sistema de Alerta Precoce (Forecasting T->T+1) para identificar alunos em risco com um ano de antecedencia.
